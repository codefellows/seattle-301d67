...
// You can't use arrow functions in constructors because it causes a type error. Whne you plug in the arrow it is assuming that a function will be returned, but the code it is trying to read is an object not a function.
...
//
//"this" is referring to the Student constructor property of name
//
// 2. What is "this" when joe.scopeArrow() is invoked?
//
//"this" is referring to the prototype instance created from the Student constructor.
//
// 3. Explain why "this" is different when an arrow function is used.
//
//"this" is different with arrow functions because it becomes lexically bound rather than dynamically bound. 